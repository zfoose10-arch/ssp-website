...
1. Home
2. Approach
3. AI Operating Partner
4. Coaching
5. About

**Navigation:** Home · Approach · AI Partner · Coaching · About

Nav uses "AI Partner" for rhythm; the page H1 carries the full name. No Resources page. No client logo row.

**Deferred: proof section.** A "patterns from the field" block (situation, presenting problem, actual diagnosis, what changed, anonymized) is planned for Home or Approach once the first real engagements close. Nothing goes live before there is a true story to tell. Layout should reserve a natural insertion point between "You can see it everywhere but in your own house" and "How I work."
...
### Section: The spring at the summit shapes everything downstream.
...
### Section: Surface fixes do not hold.
...
### Section: You can see it everywhere but in your own house.
...
### Section: When the system in question is the one being built around AI.
...
### Section: The diagnosis is the work.
...
### Section: Where the leverage usually is.
...
Start with a conversation. No fee, no pitch.
...
### Section: Patterns this work addresses.
...
### Section: Relationship to consulting.
...
### Background and training (three cards)

**Education.** M.A., Executive Coaching and Organizational Consulting, Townsend Institute. B.S., Mechanical Engineering, Colorado School of Mines.

**Experience.** 13+ years in leadership and operational roles across industries.
...
**CTA discipline.** One CTA per page, bottom only, on every page except About. "Start a Conversation" everywhere. No CTA in the hero, no CTA mid-page, no floating CTA bar. The site is a credibility resource, not a conversion funnel.

**Voice.** Short declarative sentences. The buyer is scanning. If they read one sentence per section and come away with the right impression, the copy is working. Never explain what was just said. State it and move on.

**Italic lines** are the single-sentence summary of the section they sit in. Visual punctuation, not separate callouts.
